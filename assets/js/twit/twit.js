...
// 보낸 쪽지 탭 클릭
$('#send').click(function () {
  getTwitData('http://localhost:3000/api/twits/getSend', '받는사람', '보낸시간');
})
  ...
  try {
    ...
    mainDom.innerHTML = list
      .map(twit => {
        ...
        const name = url === 'http://localhost:3000/api/twits/getReceive' ? receiverName : senderName;
        ...
        <li class="contents">
          ...
          <div class="list-info">
            <div class="classification">${name === true ? receiverName : senderName}</div>
